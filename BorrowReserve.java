...
public class BorrowReserve extends javax.swing.JFrame {

    /**
     * Creates new form BorrowReserve
     */
    public BorrowReserve() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BorrowReserve.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BorrowReserve().setVisible(true);
            }
        });
    }
